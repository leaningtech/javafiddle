...
<header class="px-4 flex items-center justify-between gap-4 relative shadow dark:shadow-none">
	...
	<ul class="my-3 text-sm flex gap-2 items-center">
		...
		<li>
			<button on:click={() => dispatch("save", undefined)} class="flex items-center rounded bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 font-semibold px-2 py-1">
